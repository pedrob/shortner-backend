...
import static com.logique.shortner.security.SecurityConstants.HEADER_STRING;
...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    public JWTAuthorizationFilter(AuthenticationManager authManager, @Value("{jwt.SECRET}") String SECRET) {
        super(authManager);
        this.SECRET = SECRET;
    }
